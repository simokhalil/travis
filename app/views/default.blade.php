        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{URL::to('/')}}"><i class="icon-bar-chart"></i><span
                    ...
                    <li><a href="#" class="dropmenu"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Forums</span></a>
                        <ul>
                            <li><a class="submenu" href="{{URL::to('forums')}}"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> Récapitulatif</span></a></li>
                            <li><a class="submenu" href="{{URL::to('listforums')}}"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> Liste des forums</span></a></li>
                            <li><a class="submenu" href="{{URL::to('report/forums')}}"><i
                                            class="icon-file-alt"></i><span class="hidden-tablet"> Détails</span></a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="#" class="dropmenu"><i class="icon-user"></i><span
                                    class="hidden-tablet"> Utilisateurs</span></a>
                        <ul>
                            <li><a class="submenu" href="{{URL::to('users')}}"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> Récapitulatif</span></a></li>
                            <li><a class="submenu" href="{{URL::to('listusers')}}"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> Liste des utilisateurs</span></a></li>
                            <li><a class="submenu" href="{{URL::to('report/date')}}"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> Historique</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
